...
#     vec0 = np.zeros(len(z))
#     vec1 = (z**3)/6
#     vec2 = (2./3) + z * (-2 + z*(2 - z/2))
#     vec3 = (-22./3) + z * (10 + z*(-4 + z/2))
#     vec4 = (32./3) + z * (-8 + z*(2 - z/6))
#     vec5 = np.zeros(len(z))

#     out = np.zeros(len(z))
#     out[z<=0]=vec0[z<=0]
#     out[(z>0) & (z<=1)]=vec1[(z>0) & (z<=1)]
#     out[(z>1) & (z<=2)]=vec2[(z>1) & (z<=2)]
#     out[(z>2) & (z<=3)]=vec3[(z>2) & (z<=3)]
#     out[(z>3) & (z<=4)]=vec4[(z>3) & (z<=4)]
#     out[z>4]=vec5[z>4]
